...
if(!isset($_GET['forgot']) && !isset($_GET['token']) && !isset($_GET['id'])){
   //header('location: forgot.php');
} else {
    $token = $_GET['token'];
    $id = $_GET['id'];
    $enlace = "reset.php?token=$token&id=$id";
}
                      ...
                      <div class="inbox-body">
                         <div class="mail-option">
                          ...
                          <table class="table table-inbox table-hover">
                            <tbody>
                              <tr class="unread">
                                  ...
                                  <td class="view-message  dont-show">DWES06</td>
                                  <td class="view-message ">Recuperar contraseña</td>
                          ...
                          <div>
                              ...
                              <p class="text-center">Haz click en el siguiente enlace para recuperar la contraseña
